...
ниже 5°C, ИЛИ средние осадки за месяц выше 200мм (муссон). Проверено
вручную на Дубае (июнь-сентябрь под 40°C) и Гоа (муссон июнь-сентябрь,
400-1200мм/мес) — совпадает с реальностью.
